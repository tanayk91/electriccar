      ...
      <div id="navbar">
        ...
        <div id="container-small">
            ...
            <div class="centre-div">
                <a href="body_material3.php" class="proceed-link left-adjacent-button">RESTART CHALLENGE</a>
            </div>
            <div class="centre-div">
                <a href="body_material4.php" class="proceed-link right-adjacent-button">CONTINUE</a>
            </div>
        </div>
    </body>
</html>
