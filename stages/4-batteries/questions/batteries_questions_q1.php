<?php
  ...
  if ($_POST['check'] == "Next Question") {
    header('Location: batteries_questions_q2.php');
  }
?>
<!DOCTYPE html>
<html>
      ...
      <div id="navbar">
        ...
        <div id="container">
            ...
            <?php
                ...
                $query_options_q1 = "SELECT `option1`,`option2`,`option3`,`option4` FROM `ecDB`.`question_options` WHERE questionID = 'c1'";
                $result_options_q1 = mysqli_query($link, $query_options_q1);

                while ($options_q1 = mysqli_fetch_object($result_options_q1)) {

                  echo '<input type="checkbox" name="ques_1[]" id="checkbox-1-1" class="regular-checkbox" value="1" /><label for="checkbox-1-1">';
                  echo $options_q1->option1;
                  echo '</label><br><br>';

                  echo '<input type="checkbox" name="ques_1[]" id="checkbox-1-2" class="regular-checkbox" value="2" /><label for="checkbox-1-2">';
                  echo $options_q1->option2;
                  echo '</label><br><br>';

                  echo '<input type="checkbox" name="ques_1[]" id="checkbox-1-3" class="regular-checkbox" value="3" /><label for="checkbox-1-3">';
                  echo $options_q1->option3;
                  echo '</label><br><br>';

                  echo '<input type="checkbox" name="ques_1[]" id="checkbox-1-4" class="regular-checkbox" value="4" /><label for="checkbox-1-4">';
