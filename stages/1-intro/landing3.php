<?php
  ...
  if ($_POST['start_challenge'] == "START") {
    header('Location: questions/pollution_questions_stage2.php');
  }
?>
<!DOCTYPE html>
<html>
    ...
    <body>
      <div id="navbar">
        ...
        <div id="container">
            ...
            <h4>Histogram</h4>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/gSEYtAjuZ-Y" frameborder="0" allowfullscreen></iframe>
            <hr />
