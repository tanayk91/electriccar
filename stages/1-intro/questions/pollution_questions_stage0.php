<?php
  ...
  //check answer
  include("../scoring/check_all_answers_update_total_0.php");

  //go to next page
  if ($_POST['check'] == "Check Answers!") {
    header('Location: ../results0.php');
  }
?>
<!DOCTYPE html>
<html>
      ...
      <div id="navbar">
        ...
        <div id="container">
            ...
            <?php
                ...
                $query_options_q1 = "SELECT `option1`,`option2`,`option3`,`option4` FROM `ecDB`.`question_options` WHERE questionID = 'p1'";
                ...
                $query_options_q2 = "SELECT `option1`,`option2`,`option3`,`option4` FROM `ecDB`.`question_options` WHERE questionID = 'p2'";
                ...
                $query_options_q3 = "SELECT `option1`,`option2`,`option3`,`option4` FROM `ecDB`.`question_options` WHERE questionID = 'p3'";
                ...
                $query_options_q4 = "SELECT `option1`,`option2`,`option3`,`option4` FROM `ecDB`.`question_options` WHERE questionID = 'p4'";
                ...
                $query_options_q5 = "SELECT `option1`,`option2`,`option3`,`option4` FROM `ecDB`.`question_options` WHERE questionID = 'p5'";
