...
if ($_POST['check'] == "Check Answers!") {
  ...
  foreach ($selected_questions as $selected_question) {
    ...
    $store_questionID = "z".$selected_question_int;
  ...
  $add_pollution_scores_query = "SELECT `score` FROM `ecDB`.`pollution_score` WHERE `userID` = '{$_SESSION['userID']}' AND `questionID` IN ('z11','z12','z13','z14','z15','z16','z17','z18','z19','z20')";
