      ...
      <div id="navbar">
        ...
        <div id="container-small">
            ...
            <div class="centre-div">
                <a href="questions/pollution_questions_q1.php" class="proceed-link left-adjacent-button">RESTART CHALLENGE</a>
            </div>
            <div class="centre-div">
                <a href="delhi3.php" class="proceed-link right-adjacent-button">CONTINUE</a>
            </div>
        </div>
    </body>
</html>
