<?php
  ...
  if ($_POST['check'] == "Next Question") {
    header('Location: wheels_questions_q4.php');
  }
?>
<!DOCTYPE html>
<html>
    <head>
        <title>wheels Questions</title>
      ...
      <div id="navbar">
        ...
        <div id="container">
            ...
            <?php
                ...
                $query_options_q3 = "SELECT `option1`,`option2`,`option3`,`option4` FROM `ecDB`.`question_options` WHERE questionID = 'e3'";
