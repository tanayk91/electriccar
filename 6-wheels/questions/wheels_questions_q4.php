<?php
  ...
  //check answer
  include("../scoring/heck_answers.php");

  //go to next page
  if ($_POST['check'] == "Next Question") {
    header('Location: wheels_questions_q5.php');
  }
?>
<!DOCTYPE html>
<html>
      ...
      <div id="navbar">
        ...
        <div id="container">
            ...
            <?php
                ...
                $query_options_q4 = "SELECT `option1`,`option2`,`option3`,`option4` FROM `ecDB`.`question_options` WHERE questionID = 'e4'";
